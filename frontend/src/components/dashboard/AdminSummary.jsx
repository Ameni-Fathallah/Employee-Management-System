...
import { FaUsers,FaBuilding, FaMoneyBillWave, FaFileAlt, FaCheckCircle, FaHourglass, FaHourglassHalf, FaTimesCircle } from 'react-icons/fa'
...
const AdminSummary = () => {
  return (
    <div className='p-6'>
        ...
        <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Salary " number="$660" color="bg-red-600"/>
        </div>
        ...
        <div className='mt-12'>
            <h4 className='text-center text-2xl font-bold'>Leave Details</h4>
                ...
                <SummaryCard icon={<FaHourglassHalf/>} text="Leave Pending" number={6} color="bg-yellow-600"/>
